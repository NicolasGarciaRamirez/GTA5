...
Config.AircraftPoundPrice = 4000 -- Aircraft Pound Price.
...
Config.PointMarker = {
	...
	x = 3.0, y = 3.0, z = 1.0  -- Standard Size Circle
}
...
Config.PolicePounds = {
	Pound_LosSantos = {
		PoundPoint = { x = 449.64, y = -1014.01, z = 27.49 },
...
Config.AmbulancePounds = {
	Pound_LosSantos = {
		PoundPoint = { x = 294.75, y = -567.34, z = 42.26 },
		SpawnPoint = { x = 290.86, y = -590.31, z = 43.18, h = 225.24 }
	}
}

Config.AdminPounds = {
	Pound_LosSantos = {
		PoundPoint = { x = 1415.93, y = 1121.47, z = 100.84 },
		SpawnPoint = { x = 1406.22, y = 1118.53, z = 114.84, h = 93.17 }
	}
}
...
Config.CarPounds = {
	Pound_LosSantos = {
		PoundPoint = { x = 216.92, y = -809.48, z = 29.72 },
		SpawnPoint = { x = 229.700, y = -800.1149, z = 29.5722, h = 157.84 }
	},
	Pound_Sandy = {
		PoundPoint = { x = 1730.5, y = 3709.46, z = 33.19 },
		SpawnPoint = { x = 1737.84, y = 3719.28, z = 33.04, h = 21.22 },
	},
	Pound_Paleto = {
		PoundPoint = { x = 123.06, y = 6626.5, z = 30.93 },
		SpawnPoint = { x = 128.7822, y = 6622.9965, z = 30.7828, h = 315.01 },
	}
}
